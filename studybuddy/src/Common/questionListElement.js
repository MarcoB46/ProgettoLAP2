    ...
    return (
        <View style={{marginBottom:'4%'}}>
            <Card>
                ...
                {/* <CustomText h4 ellipsizeMode='tail' numberOfLines={1} style={{textAlign:'center'}}>test titolo magari anche lungo ..</CustomText> */}
                        ...
                        <FlatList
                            ...
                            renderItem={({item}) => {
                                return(
                                    ...
                                    >
                                        <Image source={{uri: item.source}} resizeMethod='auto' resizeMode='contain' style={{width: 100, height:100 , margin:10 }}/>
                                    </TouchableHighlight>
                                    )}}
                            horizontal={true}
            ...
            >
                <View style={{flex:1, backgroundColor:'#3F51B5AA'}}>
                    <Image source={{uri: this.state.detailURI}} resizeMethod='auto' resizeMode='contain' style={{flex:1}}/>
                    <Icon
                        underlayColor='white'
                        name='arrow-left'
                        type='font-awesome'
